...
public class AuthSecret<T extends IAuthUI<char[][], Void>> implements AuthHandler {
  ...
  public static class Factory<T extends IAuthUI<char[][], Void>>
    ...
    public AuthHandler createInstance(final Response crysilResponse, final AuthType authType,
      ...
      return new AuthSecret<>(dialogType);
    }
  ...
  public AuthSecret(final Class<T> dialogType) {
    this.dialogType = dialogType;
  }
