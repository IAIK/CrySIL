...
public class CmsSignedDataInputSteam extends InputStream {
  private final InputStream    in;
  private final CMSTypedStream signedContent;
  private boolean              closed;
  private CMSSignedDataParser  sp;

  public CmsSignedDataInputSteam(final InputStream in) throws CMSException {
    try {
  ...
  public boolean verifySignatures() throws IOException, CMSException {
    if (!closed) {
