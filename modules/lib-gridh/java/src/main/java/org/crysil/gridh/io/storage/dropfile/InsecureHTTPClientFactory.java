...
public abstract class InsecureHTTPClientFactory {
  ...
  public static HttpClient createHTTPClient() throws IOException {
    ...
    try {
      ...
      sf = new InsecureHTTPClientFactory() {
      }.new InsecureSSLSocketFactory(trustStore);
    } catch (Exception e) {
      // should never happen
  ...
  protected class InsecureSSLSocketFactory extends SSLSocketFactory {
