...
import org.crysil.actor.pkcs11.strategy.SimpleSignedKeyHandleStrategy;
 ...
 */
@Test(enabled = false)
public class Pkcs11ActorSignedTest {
	...
	@BeforeMethod
	public void before() {
		module = new Pkcs11Actor(new SimpleSignedKeyHandleStrategy());
