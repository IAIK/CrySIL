package at.tugraz.iaik.skytrust.database.webservice;
...
public class WebserviceEntry implements BaseColumns {
    ...
    public static final String[] ALL_COLUMNS = new String[]{WebserviceEntry._ID, WebserviceEntry.COLUMN_NAME_TITLE, WebserviceEntry.COLUMN_NAME_HOSTNAME, WebserviceEntry.COLUMN_NAME_IP, WebserviceEntry.COLUMN_NAME_PORT, WebserviceEntry.COLUMN_NAME_SKYTRUSTID, WebserviceEntry.COLUMN_NAME_STATUS, WebserviceEntry.COLUMN_NAME_ALIAS};
    ...
    public WebserviceEntry(String title, String hostname, String ip, int port) {
        this.title = title;
